...
2026-07-24 제품 기준에서도 그늘 서비스 범위는 **건물 그늘**입니다. 나무
그늘과 지형 그림자는 신뢰할 수 있는 입력·검증자료가 없어 계산하거나
추정하지 않습니다. 그늘 비율은 요청 시각의 경로 특성과 프로필·상황
적합도 입력으로 사용할 수 있지만 안전도나 실제 현장 음영 보장값은
아닙니다.

...
| 항목 | 결과 |
|---|---|
| ODsay | 값 존재, 스모크 테스트 `ApiKeyAuthFailed` |
...
1. ODsay 키 재발급 또는 애플리케이션 인증 설정 수정
...
6. 라벨링 완료 후 전역 후보 모델을 수동 학습·비교하고 운영 교체 승인
